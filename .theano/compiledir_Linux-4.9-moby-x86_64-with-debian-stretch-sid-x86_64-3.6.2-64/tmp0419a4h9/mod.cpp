...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_ma3933c3e78673b94c2ea1b3e3071a5b5 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_ma3933c3e78673b94c2ea1b3e3071a5b5() {
        ...
        ~__struct_compiled_op_ma3933c3e78673b94c2ea1b3e3071a5b5(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_7;}
                ...
                V3_n3 = PyArray_DIMS(V3)[3];
                V3_stride3 = PyArray_STRIDES(V3)[3] / sizeof(npy_float32);
                V3_jump3_3 = (V3_stride3) - (0);
                //printf("V3_jump3_3 is:");
                //std::cout << V3_jump3_3 << std::endl;
                
                V3_n2 = PyArray_DIMS(V3)[2];
                V3_stride2 = PyArray_STRIDES(V3)[2] / sizeof(npy_float32);
                V3_jump2_2 = (V3_stride2) - (V3_n3*V3_stride3);
        ...
        goto __label_7;}
                ...
                V5_jumpx_3 = -(0);
                //printf("V5_jumpx_3 is:");
                //std::cout << V5_jumpx_3 << std::endl;
    ...
    {
        npy_intp dims[4];
        //npy_intp* dims = (npy_intp*)malloc(4 * sizeof(npy_intp));
        dims[0] = V3_n0;
dims[1] = V3_n1;
dims[2] = V3_n2;
dims[3] = V3_n3;
        ...
        if (!V1) {
            V1 = (PyArrayObject*)PyArray_EMPTY(4, dims,
                                                    NPY_FLOAT32,
            ...
            if (!success) {
                ...
                PyErr_Clear();
                Py_XDECREF(V1);
                V1 = (PyArrayObject*)PyArray_EMPTY(4, dims, NPY_FLOAT32, 0);
            }
        }
        if (!V1) {
            {
        ...
        goto __label_7;}
                ...
                V1_n3 = PyArray_DIMS(V1)[3];
                V1_stride3 = PyArray_STRIDES(V1)[3] / sizeof(npy_float32);
                V1_jump3_3 = (V1_stride3) - (0);
                //printf("V1_jump3_3 is:");
                //std::cout << V1_jump3_3 << std::endl;
                
                V1_n2 = PyArray_DIMS(V1)[2];
                V1_stride2 = PyArray_STRIDES(V1)[2] / sizeof(npy_float32);
                V1_jump2_2 = (V1_stride2) - (V1_n3*V1_stride3);
                ...
                
{
    ...
    std::vector< std::pair<int, int> > V1_loops(4);
    std::vector< std::pair<int, int> >::iterator V1_loops_it = V1_loops.begin();
        ...
        ++V1_loops_it;
            ...
            V1_loops_it->first = abs(PyArray_STRIDES(V1)[3]);
            
        V1_loops_it->second = 3;
        ++V1_loops_it;
    ...
    int init_totals[4] = {V3_n0, V3_n1, V3_n2, V3_n3};
    ...
    V1_loops_it = V1_loops.begin();
        ...
        int TOTAL_3 = init_totals[V1_loops_it->second];
        ++V1_loops_it;
        

    int init_strides[3][4] = {
        V3_stride0, V3_stride1, V3_stride2, V3_stride3, 
0, V5_stride1, 0, 0, 
V1_stride0, V1_stride1, V1_stride2, V1_stride3
    };
    std::vector< std::pair<int, int> >::reverse_iterator V1_loops_rit;
    
        V1_loops_rit = V1_loops.rbegin();
            int V3_stride_l3 = init_strides[0][V1_loops_rit->second];
            ++V1_loops_rit;
        ...
        V1_loops_rit = V1_loops.rbegin();
            int V5_stride_l3 = init_strides[1][V1_loops_rit->second];
            ++V1_loops_rit;
        ...
        V1_loops_rit = V1_loops.rbegin();
            int V1_stride_l3 = init_strides[2][V1_loops_rit->second];
            ++V1_loops_rit;
...
V1_iter = (npy_float32*)(PyArray_DATA(V1));
        ...
        for(int ITER_3 = 0; ITER_3<TOTAL_3; ITER_3++)
        { // begin loop 3
            npy_float32 &V3_i = * ( V3_iter+V3_stride_l3*ITER_3+V3_stride_l2*ITER_2+V3_stride_l1*ITER_1+V3_stride_l0*ITER_0);
npy_float32 &V5_i = * ( V5_iter+V5_stride_l3*ITER_3+V5_stride_l2*ITER_2+V5_stride_l1*ITER_1+V5_stride_l0*ITER_0);
npy_float32 &V1_i = * ( V1_iter+V1_stride_l3*ITER_3+V1_stride_l2*ITER_2+V1_stride_l1*ITER_1+V1_stride_l0*ITER_0);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_ma3933c3e78673b94c2ea1b3e3071a5b5_executor(__struct_compiled_op_ma3933c3e78673b94c2ea1b3e3071a5b5 *self) {
            return self->run();
        }

        static void __struct_compiled_op_ma3933c3e78673b94c2ea1b3e3071a5b5_destructor(PyObject *capsule) {
            __struct_compiled_op_ma3933c3e78673b94c2ea1b3e3071a5b5 *self = (__struct_compiled_op_ma3933c3e78673b94c2ea1b3e3071a5b5 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_ma3933c3e78673b94c2ea1b3e3071a5b5* struct_ptr = new __struct_compiled_op_ma3933c3e78673b94c2ea1b3e3071a5b5();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_ma3933c3e78673b94c2ea1b3e3071a5b5_executor), NULL, __struct_compiled_op_ma3933c3e78673b94c2ea1b3e3071a5b5_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "ma3933c3e78673b94c2ea1b3e3071a5b5",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_ma3933c3e78673b94c2ea1b3e3071a5b5(void) {
   import_array();
