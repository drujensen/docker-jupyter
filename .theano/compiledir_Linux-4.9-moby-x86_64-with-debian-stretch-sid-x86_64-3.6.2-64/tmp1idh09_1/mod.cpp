...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_ma2b5a4134794691d5723cc3233a26648 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_ma2b5a4134794691d5723cc3233a26648() {
        ...
        ~__struct_compiled_op_ma2b5a4134794691d5723cc3233a26648(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_9;}
                ...
                V5_n3 = PyArray_DIMS(V5)[3];
                V5_stride3 = PyArray_STRIDES(V5)[3] / sizeof(npy_float32);
                V5_jump3_3 = (V5_stride3) - (0);
                //printf("V5_jump3_3 is:");
                //std::cout << V5_jump3_3 << std::endl;
                
                V5_n2 = PyArray_DIMS(V5)[2];
                V5_stride2 = PyArray_STRIDES(V5)[2] / sizeof(npy_float32);
                V5_jump2_2 = (V5_stride2) - (V5_n3*V5_stride3);
        ...
        goto __label_9;}
                ...
                V7_jumpx_3 = -(0);
                //printf("V7_jumpx_3 is:");
                //std::cout << V7_jumpx_3 << std::endl;
            ...
            
{
    ...
    std::vector< std::pair<int, int> > V5_loops(4);
    std::vector< std::pair<int, int> >::iterator V5_loops_it = V5_loops.begin();
        ...
        ++V5_loops_it;
            ...
            V5_loops_it->first = abs(PyArray_STRIDES(V5)[3]);
            
        V5_loops_it->second = 3;
        ++V5_loops_it;
    ...
    int init_totals[4] = {V5_n0, V5_n1, V5_n2, V5_n3};
    ...
    V5_loops_it = V5_loops.begin();
        ...
        int TOTAL_3 = init_totals[V5_loops_it->second];
        ++V5_loops_it;
        

    int init_strides[3][4] = {
        0, 0, 0, 0, 
V5_stride0, V5_stride1, V5_stride2, V5_stride3, 
0, V7_stride1, 0, 0
    };
    std::vector< std::pair<int, int> >::reverse_iterator V5_loops_rit;
    
        V5_loops_rit = V5_loops.rbegin();
            int V3_stride_l3 = init_strides[0][V5_loops_rit->second];
            ++V5_loops_rit;
        ...
        V5_loops_rit = V5_loops.rbegin();
            int V5_stride_l3 = init_strides[1][V5_loops_rit->second];
            ++V5_loops_rit;
        ...
        V5_loops_rit = V5_loops.rbegin();
            int V7_stride_l3 = init_strides[2][V5_loops_rit->second];
            ++V5_loops_rit;
...
npy_float32 &V7_i = * ( V7_iter+V7_stride_l3*ITER_3+V7_stride_l2*ITER_2+V7_stride_l1*ITER_1+V7_stride_l0*ITER_0);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_ma2b5a4134794691d5723cc3233a26648_executor(__struct_compiled_op_ma2b5a4134794691d5723cc3233a26648 *self) {
            return self->run();
        }

        static void __struct_compiled_op_ma2b5a4134794691d5723cc3233a26648_destructor(PyObject *capsule) {
            __struct_compiled_op_ma2b5a4134794691d5723cc3233a26648 *self = (__struct_compiled_op_ma2b5a4134794691d5723cc3233a26648 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_ma2b5a4134794691d5723cc3233a26648* struct_ptr = new __struct_compiled_op_ma2b5a4134794691d5723cc3233a26648();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_ma2b5a4134794691d5723cc3233a26648_executor), NULL, __struct_compiled_op_ma2b5a4134794691d5723cc3233a26648_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "ma2b5a4134794691d5723cc3233a26648",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_ma2b5a4134794691d5723cc3233a26648(void) {
   import_array();
