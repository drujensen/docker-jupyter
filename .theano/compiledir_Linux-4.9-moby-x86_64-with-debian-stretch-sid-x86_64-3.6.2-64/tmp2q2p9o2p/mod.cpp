...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_mf1854ce97526660d1d5e5164c63b60fd {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_mf1854ce97526660d1d5e5164c63b60fd() {
        ...
        ~__struct_compiled_op_mf1854ce97526660d1d5e5164c63b60fd(void) {
            cleanup();
        }
...
npy_int8 &V5_i = * ( V5_iter + ITER_0 * V5_jumpx_0 );
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_mf1854ce97526660d1d5e5164c63b60fd_executor(__struct_compiled_op_mf1854ce97526660d1d5e5164c63b60fd *self) {
            return self->run();
        }

        static void __struct_compiled_op_mf1854ce97526660d1d5e5164c63b60fd_destructor(PyObject *capsule) {
            __struct_compiled_op_mf1854ce97526660d1d5e5164c63b60fd *self = (__struct_compiled_op_mf1854ce97526660d1d5e5164c63b60fd *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_mf1854ce97526660d1d5e5164c63b60fd* struct_ptr = new __struct_compiled_op_mf1854ce97526660d1d5e5164c63b60fd();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_mf1854ce97526660d1d5e5164c63b60fd_executor), NULL, __struct_compiled_op_mf1854ce97526660d1d5e5164c63b60fd_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "mf1854ce97526660d1d5e5164c63b60fd",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_mf1854ce97526660d1d5e5164c63b60fd(void) {
   import_array();
