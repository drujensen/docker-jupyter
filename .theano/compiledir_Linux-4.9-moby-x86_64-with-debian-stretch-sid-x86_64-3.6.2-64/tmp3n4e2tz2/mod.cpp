...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_me51c7088e7d7db9861cbd64db519e0c1 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_me51c7088e7d7db9861cbd64db519e0c1() {
        ...
        ~__struct_compiled_op_me51c7088e7d7db9861cbd64db519e0c1(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_me51c7088e7d7db9861cbd64db519e0c1_executor(__struct_compiled_op_me51c7088e7d7db9861cbd64db519e0c1 *self) {
            return self->run();
        }

        static void __struct_compiled_op_me51c7088e7d7db9861cbd64db519e0c1_destructor(PyObject *capsule) {
            __struct_compiled_op_me51c7088e7d7db9861cbd64db519e0c1 *self = (__struct_compiled_op_me51c7088e7d7db9861cbd64db519e0c1 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_me51c7088e7d7db9861cbd64db519e0c1* struct_ptr = new __struct_compiled_op_me51c7088e7d7db9861cbd64db519e0c1();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_me51c7088e7d7db9861cbd64db519e0c1_executor), NULL, __struct_compiled_op_me51c7088e7d7db9861cbd64db519e0c1_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "me51c7088e7d7db9861cbd64db519e0c1",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_me51c7088e7d7db9861cbd64db519e0c1(void) {
   import_array();
