...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m7368e167fdf326c00f8385a71ac46c4b {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m7368e167fdf326c00f8385a71ac46c4b() {
        ...
        ~__struct_compiled_op_m7368e167fdf326c00f8385a71ac46c4b(void) {
            cleanup();
        }
...
// Op class SoftmaxGrad
        ...
        if (PyArray_DIMS(V3)[0] != PyArray_DIMS(V5)[0])
        {
        ...
        {
            const dtype_V3* __restrict__ dy_i = (dtype_V3*) (PyArray_BYTES(V3) + PyArray_STRIDES(V3)[0] * i);
            npy_intp Sdy = PyArray_STRIDES(V3)[1]/sizeof(dtype_V3);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m7368e167fdf326c00f8385a71ac46c4b_executor(__struct_compiled_op_m7368e167fdf326c00f8385a71ac46c4b *self) {
            return self->run();
        }

        static void __struct_compiled_op_m7368e167fdf326c00f8385a71ac46c4b_destructor(PyObject *capsule) {
            __struct_compiled_op_m7368e167fdf326c00f8385a71ac46c4b *self = (__struct_compiled_op_m7368e167fdf326c00f8385a71ac46c4b *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m7368e167fdf326c00f8385a71ac46c4b* struct_ptr = new __struct_compiled_op_m7368e167fdf326c00f8385a71ac46c4b();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m7368e167fdf326c00f8385a71ac46c4b_executor), NULL, __struct_compiled_op_m7368e167fdf326c00f8385a71ac46c4b_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "m7368e167fdf326c00f8385a71ac46c4b",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_m7368e167fdf326c00f8385a71ac46c4b(void) {
   import_array();
