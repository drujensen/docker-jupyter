...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_mb9eb3311ca4d62ae75623fc5c327fad8 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_mb9eb3311ca4d62ae75623fc5c327fad8() {
        ...
        ~__struct_compiled_op_mb9eb3311ca4d62ae75623fc5c327fad8(void) {
            cleanup();
        }
...
npy_float32& V9_i = *V9_iter;
npy_float32& V11_i = *V11_iter;
npy_float32& V13_i = *V13_iter;
npy_float32& V15_i = *V15_iter;
npy_float32& V1_i = *V1_iter;

                  {
npy_float32 V17_tmp1;
V17_tmp1 = pow(V15_i, V9_i);
npy_float32 V17_tmp2;
V17_tmp2 = pow(V7_i, V9_i);
npy_float32 V17_tmp3;
V17_tmp3 = V5_i - V17_tmp1;
npy_float32 V17_tmp4;
V17_tmp4 = V5_i - V17_tmp2;
npy_float32 V17_tmp5;
V17_tmp5 = V17_tmp4 < V11_i ? V11_i : V17_tmp4 > V13_i ? V13_i : V17_tmp4;
npy_float32 V17_tmp6;
V17_tmp6 = sqrt(V17_tmp5);
npy_float32 V17_tmp7;
V17_tmp7 = V17_tmp6 / V17_tmp3;
V1_i = V3_i * V17_tmp7;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_mb9eb3311ca4d62ae75623fc5c327fad8_executor(__struct_compiled_op_mb9eb3311ca4d62ae75623fc5c327fad8 *self) {
            return self->run();
        }

        static void __struct_compiled_op_mb9eb3311ca4d62ae75623fc5c327fad8_destructor(PyObject *capsule) {
            __struct_compiled_op_mb9eb3311ca4d62ae75623fc5c327fad8 *self = (__struct_compiled_op_mb9eb3311ca4d62ae75623fc5c327fad8 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_mb9eb3311ca4d62ae75623fc5c327fad8* struct_ptr = new __struct_compiled_op_mb9eb3311ca4d62ae75623fc5c327fad8();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4),PyTuple_GET_ITEM(argtuple, 5),PyTuple_GET_ITEM(argtuple, 6),PyTuple_GET_ITEM(argtuple, 7),PyTuple_GET_ITEM(argtuple, 8) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_mb9eb3311ca4d62ae75623fc5c327fad8_executor), NULL, __struct_compiled_op_mb9eb3311ca4d62ae75623fc5c327fad8_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "mb9eb3311ca4d62ae75623fc5c327fad8",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_mb9eb3311ca4d62ae75623fc5c327fad8(void) {
   import_array();
