...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m66ca6565a50f51a1d42a23dd2f3879e3 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m66ca6565a50f51a1d42a23dd2f3879e3() {
        ...
        ~__struct_compiled_op_m66ca6565a50f51a1d42a23dd2f3879e3(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m66ca6565a50f51a1d42a23dd2f3879e3_executor(__struct_compiled_op_m66ca6565a50f51a1d42a23dd2f3879e3 *self) {
            return self->run();
        }

        static void __struct_compiled_op_m66ca6565a50f51a1d42a23dd2f3879e3_destructor(PyObject *capsule) {
            __struct_compiled_op_m66ca6565a50f51a1d42a23dd2f3879e3 *self = (__struct_compiled_op_m66ca6565a50f51a1d42a23dd2f3879e3 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m66ca6565a50f51a1d42a23dd2f3879e3* struct_ptr = new __struct_compiled_op_m66ca6565a50f51a1d42a23dd2f3879e3();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m66ca6565a50f51a1d42a23dd2f3879e3_executor), NULL, __struct_compiled_op_m66ca6565a50f51a1d42a23dd2f3879e3_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "m66ca6565a50f51a1d42a23dd2f3879e3",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_m66ca6565a50f51a1d42a23dd2f3879e3(void) {
   import_array();
