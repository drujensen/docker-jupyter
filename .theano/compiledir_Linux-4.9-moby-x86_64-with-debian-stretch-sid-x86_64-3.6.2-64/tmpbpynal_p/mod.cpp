...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m1a903c7e0797bb32efd47067025562ed {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m1a903c7e0797bb32efd47067025562ed() {
        ...
        ~__struct_compiled_op_m1a903c7e0797bb32efd47067025562ed(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_19;}
                ...
                V5_stride1 = PyArray_STRIDES(V5)[1] / sizeof(npy_bool);
            ...
            
{
    ...
    std::vector< std::pair<int, int> > V13_loops(2);
    std::vector< std::pair<int, int> >::iterator V13_loops_it = V13_loops.begin();
    
            V13_loops_it->first = abs(PyArray_STRIDES(V13)[0]);
            
        V13_loops_it->second = 0;
        ++V13_loops_it;
        
            V13_loops_it->first = abs(PyArray_STRIDES(V13)[1]);
            
        V13_loops_it->second = 1;
        ++V13_loops_it;
        
    // rbegin and rend are reversed iterators, so this sorts in decreasing order
    std::sort(V13_loops.rbegin(), V13_loops.rend());
    

    int init_totals[2] = {V5_n0, V5_n1};
    
    V13_loops_it = V13_loops.begin();
    
        int TOTAL_0 = init_totals[V13_loops_it->second];
        ++V13_loops_it;
        
        int TOTAL_1 = init_totals[V13_loops_it->second];
        ++V13_loops_it;
...
V17_stride0, 0
    ...
    std::vector< std::pair<int, int> >::reverse_iterator V13_loops_rit;
    
        V13_loops_rit = V13_loops.rbegin();
            int V3_stride_l1 = init_strides[0][V13_loops_rit->second];
            ++V13_loops_rit;
            
            int V3_stride_l0 = init_strides[0][V13_loops_rit->second];
            ++V13_loops_rit;
            
        V13_loops_rit = V13_loops.rbegin();
            int V5_stride_l1 = init_strides[1][V13_loops_rit->second];
            ++V13_loops_rit;
            
            int V5_stride_l0 = init_strides[1][V13_loops_rit->second];
            ++V13_loops_rit;
            
        V13_loops_rit = V13_loops.rbegin();
            int V7_stride_l1 = init_strides[2][V13_loops_rit->second];
            ++V13_loops_rit;
            
            int V7_stride_l0 = init_strides[2][V13_loops_rit->second];
            ++V13_loops_rit;
            
        V13_loops_rit = V13_loops.rbegin();
            int V9_stride_l1 = init_strides[3][V13_loops_rit->second];
            ++V13_loops_rit;
            
            int V9_stride_l0 = init_strides[3][V13_loops_rit->second];
            ++V13_loops_rit;
            
        V13_loops_rit = V13_loops.rbegin();
            int V11_stride_l1 = init_strides[4][V13_loops_rit->second];
            ++V13_loops_rit;
            
            int V11_stride_l0 = init_strides[4][V13_loops_rit->second];
            ++V13_loops_rit;
            
        V13_loops_rit = V13_loops.rbegin();
            int V13_stride_l1 = init_strides[5][V13_loops_rit->second];
            ++V13_loops_rit;
            
            int V13_stride_l0 = init_strides[5][V13_loops_rit->second];
            ++V13_loops_rit;
            
        V13_loops_rit = V13_loops.rbegin();
            int V15_stride_l1 = init_strides[6][V13_loops_rit->second];
            ++V13_loops_rit;
            
            int V15_stride_l0 = init_strides[6][V13_loops_rit->second];
            ++V13_loops_rit;
            
        V13_loops_rit = V13_loops.rbegin();
            int V17_stride_l1 = init_strides[7][V13_loops_rit->second];
            ++V13_loops_rit;
            
            int V17_stride_l0 = init_strides[7][V13_loops_rit->second];
            ++V13_loops_rit;
...
npy_bool &V5_i = * ( V5_iter+V5_stride_l1*ITER_1+V5_stride_l0*ITER_0);
...
V19_tmp1 = V13_i * V15_i;
npy_float32 V19_tmp2;
V19_tmp2 = V3_i * V5_i * V7_i * V9_i * V11_i;
npy_float32 V19_tmp3;
V19_tmp3 = V19_tmp2 / V19_tmp1;
V1_i = V19_tmp3 + V17_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m1a903c7e0797bb32efd47067025562ed_executor(__struct_compiled_op_m1a903c7e0797bb32efd47067025562ed *self) {
            return self->run();
        }

        static void __struct_compiled_op_m1a903c7e0797bb32efd47067025562ed_destructor(PyObject *capsule) {
            __struct_compiled_op_m1a903c7e0797bb32efd47067025562ed *self = (__struct_compiled_op_m1a903c7e0797bb32efd47067025562ed *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m1a903c7e0797bb32efd47067025562ed* struct_ptr = new __struct_compiled_op_m1a903c7e0797bb32efd47067025562ed();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4),PyTuple_GET_ITEM(argtuple, 5),PyTuple_GET_ITEM(argtuple, 6),PyTuple_GET_ITEM(argtuple, 7),PyTuple_GET_ITEM(argtuple, 8),PyTuple_GET_ITEM(argtuple, 9) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m1a903c7e0797bb32efd47067025562ed_executor), NULL, __struct_compiled_op_m1a903c7e0797bb32efd47067025562ed_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "m1a903c7e0797bb32efd47067025562ed",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_m1a903c7e0797bb32efd47067025562ed(void) {
   import_array();
