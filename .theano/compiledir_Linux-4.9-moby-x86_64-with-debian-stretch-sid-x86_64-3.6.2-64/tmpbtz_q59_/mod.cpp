...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_me109d16d6bc4bbc8e6f8e76cd8fba5fc {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_me109d16d6bc4bbc8e6f8e76cd8fba5fc() {
        ...
        ~__struct_compiled_op_me109d16d6bc4bbc8e6f8e76cd8fba5fc(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_me109d16d6bc4bbc8e6f8e76cd8fba5fc_executor(__struct_compiled_op_me109d16d6bc4bbc8e6f8e76cd8fba5fc *self) {
            return self->run();
        }

        static void __struct_compiled_op_me109d16d6bc4bbc8e6f8e76cd8fba5fc_destructor(PyObject *capsule) {
            __struct_compiled_op_me109d16d6bc4bbc8e6f8e76cd8fba5fc *self = (__struct_compiled_op_me109d16d6bc4bbc8e6f8e76cd8fba5fc *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_me109d16d6bc4bbc8e6f8e76cd8fba5fc* struct_ptr = new __struct_compiled_op_me109d16d6bc4bbc8e6f8e76cd8fba5fc();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_me109d16d6bc4bbc8e6f8e76cd8fba5fc_executor), NULL, __struct_compiled_op_me109d16d6bc4bbc8e6f8e76cd8fba5fc_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "me109d16d6bc4bbc8e6f8e76cd8fba5fc",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_me109d16d6bc4bbc8e6f8e76cd8fba5fc(void) {
   import_array();
