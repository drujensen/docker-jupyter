...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m2c1722ddb67e0fa1800d7cd9c2f06511 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m2c1722ddb67e0fa1800d7cd9c2f06511() {
        ...
        ~__struct_compiled_op_m2c1722ddb67e0fa1800d7cd9c2f06511(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_11;}
            ...
            if((PyArray_ISCONTIGUOUS(V5) && PyArray_ISCONTIGUOUS(V9) && PyArray_ISCONTIGUOUS(V1)) || (PyArray_ISFORTRAN(V5) && PyArray_ISFORTRAN(V9) && PyArray_ISFORTRAN(V1))){
...
V11_tmp3 = V7_i * V11_tmp1;
V1_i = V11_tmp2 + V11_tmp3;
}
;
                    }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m2c1722ddb67e0fa1800d7cd9c2f06511_executor(__struct_compiled_op_m2c1722ddb67e0fa1800d7cd9c2f06511 *self) {
            return self->run();
        }

        static void __struct_compiled_op_m2c1722ddb67e0fa1800d7cd9c2f06511_destructor(PyObject *capsule) {
            __struct_compiled_op_m2c1722ddb67e0fa1800d7cd9c2f06511 *self = (__struct_compiled_op_m2c1722ddb67e0fa1800d7cd9c2f06511 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m2c1722ddb67e0fa1800d7cd9c2f06511* struct_ptr = new __struct_compiled_op_m2c1722ddb67e0fa1800d7cd9c2f06511();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4),PyTuple_GET_ITEM(argtuple, 5) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m2c1722ddb67e0fa1800d7cd9c2f06511_executor), NULL, __struct_compiled_op_m2c1722ddb67e0fa1800d7cd9c2f06511_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "m2c1722ddb67e0fa1800d7cd9c2f06511",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_m2c1722ddb67e0fa1800d7cd9c2f06511(void) {
   import_array();
