...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m96866904e0b801899d8113d0b74f5fd3 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m96866904e0b801899d8113d0b74f5fd3() {
        ...
        ~__struct_compiled_op_m96866904e0b801899d8113d0b74f5fd3(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m96866904e0b801899d8113d0b74f5fd3_executor(__struct_compiled_op_m96866904e0b801899d8113d0b74f5fd3 *self) {
            return self->run();
        }

        static void __struct_compiled_op_m96866904e0b801899d8113d0b74f5fd3_destructor(PyObject *capsule) {
            __struct_compiled_op_m96866904e0b801899d8113d0b74f5fd3 *self = (__struct_compiled_op_m96866904e0b801899d8113d0b74f5fd3 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m96866904e0b801899d8113d0b74f5fd3* struct_ptr = new __struct_compiled_op_m96866904e0b801899d8113d0b74f5fd3();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m96866904e0b801899d8113d0b74f5fd3_executor), NULL, __struct_compiled_op_m96866904e0b801899d8113d0b74f5fd3_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "m96866904e0b801899d8113d0b74f5fd3",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_m96866904e0b801899d8113d0b74f5fd3(void) {
   import_array();
