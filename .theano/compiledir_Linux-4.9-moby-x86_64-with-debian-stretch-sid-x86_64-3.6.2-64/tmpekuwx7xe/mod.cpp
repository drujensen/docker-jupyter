...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m83846a5c2cf8791382e819214744f9d9 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m83846a5c2cf8791382e819214744f9d9() {
        ...
        ~__struct_compiled_op_m83846a5c2cf8791382e819214744f9d9(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m83846a5c2cf8791382e819214744f9d9_executor(__struct_compiled_op_m83846a5c2cf8791382e819214744f9d9 *self) {
            return self->run();
        }

        static void __struct_compiled_op_m83846a5c2cf8791382e819214744f9d9_destructor(PyObject *capsule) {
            __struct_compiled_op_m83846a5c2cf8791382e819214744f9d9 *self = (__struct_compiled_op_m83846a5c2cf8791382e819214744f9d9 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m83846a5c2cf8791382e819214744f9d9* struct_ptr = new __struct_compiled_op_m83846a5c2cf8791382e819214744f9d9();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m83846a5c2cf8791382e819214744f9d9_executor), NULL, __struct_compiled_op_m83846a5c2cf8791382e819214744f9d9_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "m83846a5c2cf8791382e819214744f9d9",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_m83846a5c2cf8791382e819214744f9d9(void) {
   import_array();
