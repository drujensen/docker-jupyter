...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m0d5052aed3301dd07f5dbbbd02166f71 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m0d5052aed3301dd07f5dbbbd02166f71() {
        ...
        ~__struct_compiled_op_m0d5052aed3301dd07f5dbbbd02166f71(void) {
            cleanup();
        }
...
PyArrayObject * xview = NULL;
        ...
        npy_intp xview_dims[4];
        npy_intp xview_strides[4];
        ...
        int is_slice[] = {1,1,1,1};
        npy_intp subtensor_spec[12];
...
subtensor_spec[8] = V5;
subtensor_spec[9] = 9223372036854775806;
subtensor_spec[10] = 9223372036854775806;
subtensor_spec[11] = V5;;
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m0d5052aed3301dd07f5dbbbd02166f71_executor(__struct_compiled_op_m0d5052aed3301dd07f5dbbbd02166f71 *self) {
            return self->run();
        }

        static void __struct_compiled_op_m0d5052aed3301dd07f5dbbbd02166f71_destructor(PyObject *capsule) {
            __struct_compiled_op_m0d5052aed3301dd07f5dbbbd02166f71 *self = (__struct_compiled_op_m0d5052aed3301dd07f5dbbbd02166f71 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m0d5052aed3301dd07f5dbbbd02166f71* struct_ptr = new __struct_compiled_op_m0d5052aed3301dd07f5dbbbd02166f71();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m0d5052aed3301dd07f5dbbbd02166f71_executor), NULL, __struct_compiled_op_m0d5052aed3301dd07f5dbbbd02166f71_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "m0d5052aed3301dd07f5dbbbd02166f71",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_m0d5052aed3301dd07f5dbbbd02166f71(void) {
   import_array();
