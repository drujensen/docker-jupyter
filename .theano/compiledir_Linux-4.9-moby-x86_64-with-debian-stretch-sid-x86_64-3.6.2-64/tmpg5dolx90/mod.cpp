...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_ma44e69620ebe40968eaa6e5692e9bc09 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_ma44e69620ebe40968eaa6e5692e9bc09() {
        ...
        ~__struct_compiled_op_ma44e69620ebe40968eaa6e5692e9bc09(void) {
            cleanup();
        }
...
V11_tmp1 = (npy_float32)V7_i;
npy_float32 V11_tmp2;
V11_tmp2 = -V3_i;
npy_float32 V11_tmp3;
V11_tmp3 = V5_i / V11_tmp1;
npy_float32 V11_tmp4;
V11_tmp4 = V11_tmp2 / V11_tmp3;
V1_i = V11_tmp4 / V9_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_ma44e69620ebe40968eaa6e5692e9bc09_executor(__struct_compiled_op_ma44e69620ebe40968eaa6e5692e9bc09 *self) {
            return self->run();
        }

        static void __struct_compiled_op_ma44e69620ebe40968eaa6e5692e9bc09_destructor(PyObject *capsule) {
            __struct_compiled_op_ma44e69620ebe40968eaa6e5692e9bc09 *self = (__struct_compiled_op_ma44e69620ebe40968eaa6e5692e9bc09 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_ma44e69620ebe40968eaa6e5692e9bc09* struct_ptr = new __struct_compiled_op_ma44e69620ebe40968eaa6e5692e9bc09();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4),PyTuple_GET_ITEM(argtuple, 5) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_ma44e69620ebe40968eaa6e5692e9bc09_executor), NULL, __struct_compiled_op_ma44e69620ebe40968eaa6e5692e9bc09_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "ma44e69620ebe40968eaa6e5692e9bc09",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_ma44e69620ebe40968eaa6e5692e9bc09(void) {
   import_array();
