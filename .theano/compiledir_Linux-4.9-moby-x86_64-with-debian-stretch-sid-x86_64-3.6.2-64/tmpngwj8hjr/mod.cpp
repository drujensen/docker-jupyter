...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m83cec04f5bd464ba133c1242b8b591ad {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m83cec04f5bd464ba133c1242b8b591ad() {
        ...
        ~__struct_compiled_op_m83cec04f5bd464ba133c1242b8b591ad(void) {
            cleanup();
        }
...
0, 0
    ...
    std::vector< std::pair<int, int> >::reverse_iterator V5_loops_rit;
        ...
        V5_loops_rit = V5_loops.rbegin();
            int V11_stride_l1 = init_strides[4][V5_loops_rit->second];
            ++V5_loops_rit;
            
            int V11_stride_l0 = init_strides[4][V5_loops_rit->second];
            ++V5_loops_rit;
...
V13_tmp2 = V13_tmp1 < V9_i ? V9_i : V13_tmp1 > V11_i ? V11_i : V13_tmp1;
npy_float32 V13_tmp3;
V13_tmp3 = log(V13_tmp2);
V1_i = V3_i * V13_tmp3;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m83cec04f5bd464ba133c1242b8b591ad_executor(__struct_compiled_op_m83cec04f5bd464ba133c1242b8b591ad *self) {
            return self->run();
        }

        static void __struct_compiled_op_m83cec04f5bd464ba133c1242b8b591ad_destructor(PyObject *capsule) {
            __struct_compiled_op_m83cec04f5bd464ba133c1242b8b591ad *self = (__struct_compiled_op_m83cec04f5bd464ba133c1242b8b591ad *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m83cec04f5bd464ba133c1242b8b591ad* struct_ptr = new __struct_compiled_op_m83cec04f5bd464ba133c1242b8b591ad();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4),PyTuple_GET_ITEM(argtuple, 5),PyTuple_GET_ITEM(argtuple, 6) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m83cec04f5bd464ba133c1242b8b591ad_executor), NULL, __struct_compiled_op_m83cec04f5bd464ba133c1242b8b591ad_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "m83cec04f5bd464ba133c1242b8b591ad",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_m83cec04f5bd464ba133c1242b8b591ad(void) {
   import_array();
