...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_mf13368348569313d75539f1aad1b0ceb {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_mf13368348569313d75539f1aad1b0ceb() {
        ...
        ~__struct_compiled_op_mf13368348569313d75539f1aad1b0ceb(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_mf13368348569313d75539f1aad1b0ceb_executor(__struct_compiled_op_mf13368348569313d75539f1aad1b0ceb *self) {
            return self->run();
        }

        static void __struct_compiled_op_mf13368348569313d75539f1aad1b0ceb_destructor(PyObject *capsule) {
            __struct_compiled_op_mf13368348569313d75539f1aad1b0ceb *self = (__struct_compiled_op_mf13368348569313d75539f1aad1b0ceb *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_mf13368348569313d75539f1aad1b0ceb* struct_ptr = new __struct_compiled_op_mf13368348569313d75539f1aad1b0ceb();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4),PyTuple_GET_ITEM(argtuple, 5),PyTuple_GET_ITEM(argtuple, 6) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_mf13368348569313d75539f1aad1b0ceb_executor), NULL, __struct_compiled_op_mf13368348569313d75539f1aad1b0ceb_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "mf13368348569313d75539f1aad1b0ceb",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_mf13368348569313d75539f1aad1b0ceb(void) {
   import_array();
