...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m1c35ead71386393d05218ca1f562a8f1 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m1c35ead71386393d05218ca1f562a8f1() {
        ...
        ~__struct_compiled_op_m1c35ead71386393d05218ca1f562a8f1(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m1c35ead71386393d05218ca1f562a8f1_executor(__struct_compiled_op_m1c35ead71386393d05218ca1f562a8f1 *self) {
            return self->run();
        }

        static void __struct_compiled_op_m1c35ead71386393d05218ca1f562a8f1_destructor(PyObject *capsule) {
            __struct_compiled_op_m1c35ead71386393d05218ca1f562a8f1 *self = (__struct_compiled_op_m1c35ead71386393d05218ca1f562a8f1 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m1c35ead71386393d05218ca1f562a8f1* struct_ptr = new __struct_compiled_op_m1c35ead71386393d05218ca1f562a8f1();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m1c35ead71386393d05218ca1f562a8f1_executor), NULL, __struct_compiled_op_m1c35ead71386393d05218ca1f562a8f1_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "m1c35ead71386393d05218ca1f562a8f1",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_m1c35ead71386393d05218ca1f562a8f1(void) {
   import_array();
