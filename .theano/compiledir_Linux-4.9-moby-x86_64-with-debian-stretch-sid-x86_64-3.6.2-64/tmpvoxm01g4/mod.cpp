...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m37f69bf4023960dbb316ab4c9e905bd3 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m37f69bf4023960dbb316ab4c9e905bd3() {
        ...
        ~__struct_compiled_op_m37f69bf4023960dbb316ab4c9e905bd3(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_17;}
                ...
                V3_stride1 = PyArray_STRIDES(V3)[1] / sizeof(npy_bool);
...
dims[1] = V3_n1;
        ...
        if (!V1) {
            V1 = (PyArrayObject*)PyArray_EMPTY(2, dims,
                                                    NPY_FLOAT32,
                                                    PyArray_ISFORTRAN(V3) && PyArray_ISFORTRAN(V7) && PyArray_ISFORTRAN(V9) && PyArray_ISFORTRAN(V11) && PyArray_ISFORTRAN(V13) && PyArray_ISFORTRAN(V15));
        }
        else {
...
V17_tmp1 = V13_i * V15_i * V15_i;
npy_float32 V17_tmp2;
V17_tmp2 = V3_i * V5_i * V7_i * V9_i * V11_i;
V1_i = V17_tmp2 / V17_tmp1;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m37f69bf4023960dbb316ab4c9e905bd3_executor(__struct_compiled_op_m37f69bf4023960dbb316ab4c9e905bd3 *self) {
            return self->run();
        }

        static void __struct_compiled_op_m37f69bf4023960dbb316ab4c9e905bd3_destructor(PyObject *capsule) {
            __struct_compiled_op_m37f69bf4023960dbb316ab4c9e905bd3 *self = (__struct_compiled_op_m37f69bf4023960dbb316ab4c9e905bd3 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m37f69bf4023960dbb316ab4c9e905bd3* struct_ptr = new __struct_compiled_op_m37f69bf4023960dbb316ab4c9e905bd3();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4),PyTuple_GET_ITEM(argtuple, 5),PyTuple_GET_ITEM(argtuple, 6),PyTuple_GET_ITEM(argtuple, 7),PyTuple_GET_ITEM(argtuple, 8) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m37f69bf4023960dbb316ab4c9e905bd3_executor), NULL, __struct_compiled_op_m37f69bf4023960dbb316ab4c9e905bd3_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "m37f69bf4023960dbb316ab4c9e905bd3",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_m37f69bf4023960dbb316ab4c9e905bd3(void) {
   import_array();
