...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_mc7f38f2ae830529e0db7b8f9f8ed5105 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_mc7f38f2ae830529e0db7b8f9f8ed5105() {
        ...
        ~__struct_compiled_op_mc7f38f2ae830529e0db7b8f9f8ed5105(void) {
            cleanup();
        }
...
// Op class MakeVector
        ...
        if(!V1 || PyArray_DIMS(V1)[0] != 3){
            ...
            *((npy_int64 *)PyArray_GETPTR1(V1, 2)) = *((npy_int64 *) PyArray_DATA(V5));
            __label_7:
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_mc7f38f2ae830529e0db7b8f9f8ed5105_executor(__struct_compiled_op_mc7f38f2ae830529e0db7b8f9f8ed5105 *self) {
            return self->run();
        }

        static void __struct_compiled_op_mc7f38f2ae830529e0db7b8f9f8ed5105_destructor(PyObject *capsule) {
            __struct_compiled_op_mc7f38f2ae830529e0db7b8f9f8ed5105 *self = (__struct_compiled_op_mc7f38f2ae830529e0db7b8f9f8ed5105 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_mc7f38f2ae830529e0db7b8f9f8ed5105* struct_ptr = new __struct_compiled_op_mc7f38f2ae830529e0db7b8f9f8ed5105();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_mc7f38f2ae830529e0db7b8f9f8ed5105_executor), NULL, __struct_compiled_op_mc7f38f2ae830529e0db7b8f9f8ed5105_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "mc7f38f2ae830529e0db7b8f9f8ed5105",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_mc7f38f2ae830529e0db7b8f9f8ed5105(void) {
   import_array();
