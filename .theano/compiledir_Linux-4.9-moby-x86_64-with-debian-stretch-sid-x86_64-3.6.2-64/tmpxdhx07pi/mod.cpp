...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_mb317bcb7074f7bb9cbaf324780273df4 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_mb317bcb7074f7bb9cbaf324780273df4() {
        ...
        ~__struct_compiled_op_mb317bcb7074f7bb9cbaf324780273df4(void) {
            cleanup();
        }
...
V1_stride0, V1_stride1, V1_stride2, V1_stride3
    ...
    std::vector< std::pair<int, int> >::reverse_iterator V1_loops_rit;
        ...
        V1_loops_rit = V1_loops.rbegin();
            int V1_stride_l3 = init_strides[1][V1_loops_rit->second];
            ++V1_loops_rit;
...
V1_iter = (npy_float32*)(PyArray_DATA(V1));
        ...
        { // begin loop 3
            npy_float64 &V3_i = * ( V3_iter+V3_stride_l3*ITER_3+V3_stride_l2*ITER_2+V3_stride_l1*ITER_1+V3_stride_l0*ITER_0);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_mb317bcb7074f7bb9cbaf324780273df4_executor(__struct_compiled_op_mb317bcb7074f7bb9cbaf324780273df4 *self) {
            return self->run();
        }

        static void __struct_compiled_op_mb317bcb7074f7bb9cbaf324780273df4_destructor(PyObject *capsule) {
            __struct_compiled_op_mb317bcb7074f7bb9cbaf324780273df4 *self = (__struct_compiled_op_mb317bcb7074f7bb9cbaf324780273df4 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_mb317bcb7074f7bb9cbaf324780273df4* struct_ptr = new __struct_compiled_op_mb317bcb7074f7bb9cbaf324780273df4();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_mb317bcb7074f7bb9cbaf324780273df4_executor), NULL, __struct_compiled_op_mb317bcb7074f7bb9cbaf324780273df4_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "mb317bcb7074f7bb9cbaf324780273df4",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_mb317bcb7074f7bb9cbaf324780273df4(void) {
   import_array();
