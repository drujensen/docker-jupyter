...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m84b6b44147f35af0e3f1fa8370c7992c {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m84b6b44147f35af0e3f1fa8370c7992c() {
        ...
        ~__struct_compiled_op_m84b6b44147f35af0e3f1fa8370c7992c(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_9;}
                ...
                V7_n3 = PyArray_DIMS(V7)[3];
                V7_stride3 = PyArray_STRIDES(V7)[3] / sizeof(npy_float32);
                V7_jump3_3 = (V7_stride3) - (0);
                //printf("V7_jump3_3 is:");
                //std::cout << V7_jump3_3 << std::endl;
                
                V7_n2 = PyArray_DIMS(V7)[2];
                V7_stride2 = PyArray_STRIDES(V7)[2] / sizeof(npy_float32);
                V7_jump2_2 = (V7_stride2) - (V7_n3*V7_stride3);
...
;
    ...
    std::vector< std::pair<int, int> > V7_loops(4);
    std::vector< std::pair<int, int> >::iterator V7_loops_it = V7_loops.begin();
        ...
        ++V7_loops_it;
            ...
            V7_loops_it->first = abs(PyArray_STRIDES(V7)[3]);
            
        V7_loops_it->second = 3;
        ++V7_loops_it;
    ...
    int init_totals[4] = {V7_n0, V7_n1, V7_n2, V7_n3};
    ...
    V7_loops_it = V7_loops.begin();
        ...
        int TOTAL_3 = init_totals[V7_loops_it->second];
        ++V7_loops_it;
    ...
    int init_strides[3][4] = {
        0, 0, 0, 0, 
0, 0, 0, 0, 
V7_stride0, V7_stride1, V7_stride2, V7_stride3
    };
    std::vector< std::pair<int, int> >::reverse_iterator V7_loops_rit;
    
        V7_loops_rit = V7_loops.rbegin();
            int V3_stride_l3 = init_strides[0][V7_loops_rit->second];
            ++V7_loops_rit;
        ...
        V7_loops_rit = V7_loops.rbegin();
            int V5_stride_l3 = init_strides[1][V7_loops_rit->second];
            ++V7_loops_rit;
        ...
        V7_loops_rit = V7_loops.rbegin();
            int V7_stride_l3 = init_strides[2][V7_loops_rit->second];
            ++V7_loops_rit;
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m84b6b44147f35af0e3f1fa8370c7992c_executor(__struct_compiled_op_m84b6b44147f35af0e3f1fa8370c7992c *self) {
            return self->run();
        }

        static void __struct_compiled_op_m84b6b44147f35af0e3f1fa8370c7992c_destructor(PyObject *capsule) {
            __struct_compiled_op_m84b6b44147f35af0e3f1fa8370c7992c *self = (__struct_compiled_op_m84b6b44147f35af0e3f1fa8370c7992c *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m84b6b44147f35af0e3f1fa8370c7992c* struct_ptr = new __struct_compiled_op_m84b6b44147f35af0e3f1fa8370c7992c();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m84b6b44147f35af0e3f1fa8370c7992c_executor), NULL, __struct_compiled_op_m84b6b44147f35af0e3f1fa8370c7992c_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "m84b6b44147f35af0e3f1fa8370c7992c",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_m84b6b44147f35af0e3f1fa8370c7992c(void) {
   import_array();
