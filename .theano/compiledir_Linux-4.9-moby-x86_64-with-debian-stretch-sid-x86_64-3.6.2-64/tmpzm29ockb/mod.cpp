...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m775f13f352cadb899f48994e8a962507 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m775f13f352cadb899f48994e8a962507() {
        ...
        ~__struct_compiled_op_m775f13f352cadb899f48994e8a962507(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m775f13f352cadb899f48994e8a962507_executor(__struct_compiled_op_m775f13f352cadb899f48994e8a962507 *self) {
            return self->run();
        }

        static void __struct_compiled_op_m775f13f352cadb899f48994e8a962507_destructor(PyObject *capsule) {
            __struct_compiled_op_m775f13f352cadb899f48994e8a962507 *self = (__struct_compiled_op_m775f13f352cadb899f48994e8a962507 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m775f13f352cadb899f48994e8a962507* struct_ptr = new __struct_compiled_op_m775f13f352cadb899f48994e8a962507();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4),PyTuple_GET_ITEM(argtuple, 5) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m775f13f352cadb899f48994e8a962507_executor), NULL, __struct_compiled_op_m775f13f352cadb899f48994e8a962507_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "m775f13f352cadb899f48994e8a962507",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_m775f13f352cadb899f48994e8a962507(void) {
   import_array();
