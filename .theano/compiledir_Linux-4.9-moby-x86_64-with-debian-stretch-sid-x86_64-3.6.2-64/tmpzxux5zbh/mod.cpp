...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m8e11a0055a5e0bd41355c6844b862bb6 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m8e11a0055a5e0bd41355c6844b862bb6() {
        ...
        ~__struct_compiled_op_m8e11a0055a5e0bd41355c6844b862bb6(void) {
            cleanup();
        }
...
// Op class Dot22Scalar
        ...
        */
        ...
        #define REAL float
        float a = (PyArray_DESCR(V7)->type_num == NPY_FLOAT)
        ? (REAL)(((float*)PyArray_DATA(V7))[0])
        : (REAL)(((double*)PyArray_DATA(V7))[0]);
        #undef REAL
        float b = 0.0;
        ...
        #define REAL double
        double a = (PyArray_DESCR(V7)->type_num == NPY_FLOAT)
        ? (REAL)(((float*)PyArray_DATA(V7))[0])
        : (REAL)(((double*)PyArray_DATA(V7))[0]);
        #undef REAL
        double b = 0.0;
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m8e11a0055a5e0bd41355c6844b862bb6_executor(__struct_compiled_op_m8e11a0055a5e0bd41355c6844b862bb6 *self) {
            return self->run();
        }

        static void __struct_compiled_op_m8e11a0055a5e0bd41355c6844b862bb6_destructor(PyObject *capsule) {
            __struct_compiled_op_m8e11a0055a5e0bd41355c6844b862bb6 *self = (__struct_compiled_op_m8e11a0055a5e0bd41355c6844b862bb6 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m8e11a0055a5e0bd41355c6844b862bb6* struct_ptr = new __struct_compiled_op_m8e11a0055a5e0bd41355c6844b862bb6();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m8e11a0055a5e0bd41355c6844b862bb6_executor), NULL, __struct_compiled_op_m8e11a0055a5e0bd41355c6844b862bb6_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "m8e11a0055a5e0bd41355c6844b862bb6",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_m8e11a0055a5e0bd41355c6844b862bb6(void) {
   import_array();
